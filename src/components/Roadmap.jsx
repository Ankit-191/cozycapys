...
const Roadmap = () => {
  ...
  return (
    <>
      <section
        className="bg_green_100 bg_radmap position-relative z-2"
        id="roadmapsection"
      >
        <Container className="py-5">
          ...
          <div class="container py-md-5 pt-5">
            ...
            <div className={`${phase1 === true ? "d-block" : "d-none"}`}>
              <Row className="mt-md-5 mt-4" id="cards_none">
                ...
                >
                  <div
                    class="card_phase h-100"
                    onClick={() => setPhase1(false)}
                  >
                    <p class="ff_balsamiq fs_xl fw-bold text-white mb-0">
                      Phase
                    </p>
            ...
            <div className={`${phase1 === true ? "d-none" : "d-block"}`}>
              <div class="card_phase1 my-md-5 my-4">
                <div class="d-flex justify-content-between align-items-center">
                  <h5 class="ff_balsamiq fw-bold text-white fs_4xl">Phase 1</h5>
                  <div onClick={() => setPhase1(true)} class="close_btn">
                    <Cross />
                  </div>
                </div>
                  ...
                  <div class="col-lg-8 col-12">
                    ...
                    <ul>
                      ...
                      <li class="ff_balsamiq fw-bold fs_sm text_gray mt-3">
                        ...
                        <ul class="p-0 m-0 list-unstyled">
                          <li class="my-2">
                            a. Establish social media accounts (Twitter,
                            Discord, etc.) to engage with our community and
                            generate interest
                          </li>
                        </ul>
                      </li>
                      <li class="ff_balsamiq fw-bold fs_sm text_gray mt-3">
                        ...
                        <ul class="p-0 m-0 list-unstyled">
                          ...
                          <li class="mb-2">
                            b. Write a comprehensive whitepaper that contains
                            all the specific details about Cozy Capys
                          </li>
                        </ul>
                      </li>
                    </ul>
            ...
            {/* <div className={`${phase2 === true ? "d-none" : "d-block"}`}>
              <div class="card_phase1 my-md-5 my-4">
                <div class="d-flex justify-content-between align-items-center">
                  <h5 class="ff_balsamiq fw-bold text-white fs_4xl">Phase 2</h5>
                  <div onClick={() => setPhase2(true)} class="close_btn">
                    <Cross />
                  </div>
                </div>
                <div class="row align-items-center">
            ...
            <div className={`${phase3 === true ? "d-none" : "d-block"}`}>
              <div class="card_phase1 my-md-5 my-4">
                <div class="d-flex justify-content-between align-items-center">
                  <h5 class="ff_balsamiq fw-bold text-white fs_4xl">Phase 3</h5>
                  <div onClick={() => setPhase3(true)} class="close_btn">
                    <Cross />
                  </div>
                </div>
                <div class="row align-items-center">
            ...
            <div className={`${phase4 === true ? "d-none" : "d-block"}`}>
              <div class="card_phase1 my-md-5 my-4">
                <div class="d-flex justify-content-between align-items-center">
                  <h5 class="ff_balsamiq fw-bold text-white fs_4xl">Phase 4</h5>
                  <div onClick={() => setPhase4(true)} class="close_btn">
                    <Cross />
                  </div>
                </div>
                <div class="row align-items-center">
